    ...
    (function (_elementorAdminHints, _wp, _wp$media, _wp$media$view, _wp$media$view$Attach) {
      ...
      media.view.Attachment.Details = media.view.Attachment.Details.extend({
        ...
        template: function template(view) {
          ...
          var html = media.template('attachment-details')(view); // The template to extend
        ...
        events: _objectSpread(_objectSpread({}, media.view.Attachment.Details.prototype.events), {}, {
