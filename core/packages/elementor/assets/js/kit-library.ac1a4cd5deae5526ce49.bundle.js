      ...
      function HeaderBackButton(props) {
        ...
        return /*#__PURE__*/_react.default.createElement("div", {
          ...
          onClick: function onClick() {
            ...
            navigate(url.addQueryArgs('/kit-library', lastFilter));
          }
        }));
      }
...
/* provided dependency */ var PropTypes = __webpack_require__(/*! prop-types */ "../node_modules/prop-types/index.js");
      ...
      function useRouterQueryParams(queryParams, setQueryParams) {
        ...
        (0, _react.useEffect)(function () {
          ...
          history.replaceState(null, '', decodeURI("#".concat(fn..addQueryArgs(location.pathname.split('?')[0] || '/', filteredQueryParams))));
        }, [queryParams]);
        (0, _react.useEffect)(function () {
          var routerQueryParams = Object.keys(_useKits2.defaultQueryParams).reduce(function (current, key) {
            // TODO: Replace with `fn..getQueryArgs` when WordPress 5.7 is the min version
            var queryArg = fn..getQueryArg(location.pathname, key);
            if (!queryArg) {
              return current;
            }
      ...
      function usePreviewUrl(data) {
        ...
        return (0, _react.useMemo)(function () {
          ...
          var documentId = new URLSearchParams((_location$pathname$sp = location.pathname.split('?')) === null || _location$pathname$sp === void 0 ? void 0 : _location$pathname$sp[1]).get('document_id'),
            utm = '?utm_source=kit-library&utm_medium=dash&utm_campaign=preview',
