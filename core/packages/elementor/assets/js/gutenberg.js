    ...
    (function ($) {
      ...
      var ElementorGutenbergApp = {
        ...
        handleEditButtonClick: function handleEditButtonClick() {
          ...
          var isNewPost = 'auto-draft' === data.select('core/editor').getCurrentPost().status;
          if (isNewPost) {
            var documentTitle = data.select('core/editor').getEditedPostAttribute('title');
            if (!documentTitle) {
            ...
            if (self.isElementorMode) {
              elementorCommon.dialogsManager.createWidget('confirm', {
                ...
                onConfirm: function onConfirm() {
                  var wpEditor = data.dispatch('core/editor');
                  wpEditor.editPost({
        ...
        redirectWhenSave: function redirectWhenSave() {
          var self = this;
          setTimeout(function () {
            if (data.select('core/editor').isSavingPost()) {
              self.redirectWhenSave();
            } else {
