...
/* provided dependency */ var PropTypes = __webpack_require__(/*! prop-types */ "../node_modules/prop-types/index.js");
        ...
        function DateFilter(props) {
          ...
          const options = useMemo(() => {
            const format = date => date.date('Y-m-d', date),
              now = new Date(),
...
/* provided dependency */ var PropTypes = __webpack_require__(/*! prop-types */ "../node_modules/prop-types/index.js");
        ...
        var _wpTable = _interopRequireDefault(__webpack_require__(/*! ./table */ "../modules/forms/submissions/assets/js/admin/components/table/index.js"));
        var _date = __webpack_require__(/*! ../utils/date */ "../modules/forms/submissions/assets/js/admin/utils/date.js");
        const {
          useState
        } = _react.default;
...
/***/ "../modules/forms/submissions/assets/js/admin/components/table/body.js":
/*!********************************************************************************!*\
  !*** ../modules/forms/submissions/assets/js/admin/components/table/body.js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "../modules/forms/submissions/assets/js/admin/components/table/cell.js":
/*!********************************************************************************!*\
  !*** ../modules/forms/submissions/assets/js/admin/components/table/cell.js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "../modules/forms/submissions/assets/js/admin/components/table/footer.js":
/*!**********************************************************************************!*\
  !*** ../modules/forms/submissions/assets/js/admin/components/table/footer.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "../modules/forms/submissions/assets/js/admin/components/table/header.js":
/*!**********************************************************************************!*\
  !*** ../modules/forms/submissions/assets/js/admin/components/table/header.js ***!
  \**********************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "../modules/forms/submissions/assets/js/admin/components/table/index.js":
/*!*********************************************************************************!*\
  !*** ../modules/forms/submissions/assets/js/admin/components/table/index.js ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/* provided dependency */ var PropTypes = __webpack_require__(/*! prop-types */ "../node_modules/prop-types/index.js");
        ...
        var _react = _interopRequireDefault(__webpack_require__(/*! react */ "react"));
        var _header = _interopRequireDefault(__webpack_require__(/*! ./header */ "../modules/forms/submissions/assets/js/admin/components/table/header.js"));
        var _body = _interopRequireDefault(__webpack_require__(/*! ./body */ "../modules/forms/submissions/assets/js/admin/components/table/body.js"));
        var _footer = _interopRequireDefault(__webpack_require__(/*! ./footer */ "../modules/forms/submissions/assets/js/admin/components/table/footer.js"));
        var _row = _interopRequireDefault(__webpack_require__(/*! ./row */ "../modules/forms/submissions/assets/js/admin/components/table/row.js"));
        var _cell = _interopRequireDefault(__webpack_require__(/*! ./cell */ "../modules/forms/submissions/assets/js/admin/components/table/cell.js"));
        var _orderableCell = _interopRequireDefault(__webpack_require__(/*! ./orderable-cell */ "../modules/forms/submissions/assets/js/admin/components/table/orderable-cell.js"));
        var _rowActions = _interopRequireDefault(__webpack_require__(/*! ./row-actions */ "../modules/forms/submissions/assets/js/admin/components/table/row-actions.js"));
        function WpTable(props) {
          return /*#__PURE__*/_react.default.createElement("table", {
            className: `list-table widefat fixed table-view-list ${props.className}`,
            style: props.style
          }, props.children);
        }
        WpTable.propTypes = {
...
/***/ "../modules/forms/submissions/assets/js/admin/components/table/orderable-cell.js":
/*!******************************************************************************************!*\
  !*** ../modules/forms/submissions/assets/js/admin/components/table/orderable-cell.js ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "../modules/forms/submissions/assets/js/admin/components/table/row-actions.js":
/*!***************************************************************************************!*\
  !*** ../modules/forms/submissions/assets/js/admin/components/table/row-actions.js ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "../modules/forms/submissions/assets/js/admin/components/table/row.js":
/*!*******************************************************************************!*\
  !*** ../modules/forms/submissions/assets/js/admin/components/table/row.js ***!
  \*******************************************************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/* provided dependency */ var React = __webpack_require__(/*! react */ "react");
        ...
        function downloadExportsResults(dataResults) {
          const currentDate = fn.e.date('Y-m-d');
        ...
        function useRouterQueryString(queryArgs = []) {
          ...
          useEffect(() => {
            ...
            const parsedQueryString = queryArgs.reduce((current, arg) => {
              const value = fn..getQueryArg(location.pathname, arg);
              if (undefined === value) {
                return current;
              }
              return {
          ...
          useEffect(() => {
            ...
            history.pushState(undefined, undefined, `#${fn..addQueryArgs(basePath, query)}`);
          }, [query]);
...
/* provided dependency */ var __ = __webpack_require__(/*! @wordpress/i18n */ "@wordpress/i18n")["__"];
        ...
        var _wpTable = _interopRequireDefault(__webpack_require__(/*! ../components/table */ "../modules/forms/submissions/assets/js/admin/components/table/index.js"));
...
/***/ ((__unused_webpack_module, exports) => {
        ...
        function formatToLocalDate(dateString) {
          return fn.e.format(momentLocale.longDateFormat('LL'), dateString);
        }
        function formatToLocalTime(dateString) {
          return fn.e.format(momentLocale.longDateFormat('LT'), dateString);
        }
