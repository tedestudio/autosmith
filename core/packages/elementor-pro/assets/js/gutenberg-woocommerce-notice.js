    ...
    (function ($) {
      ...
      const GutenbergWooCommerceEditorBlockNotice = {
        handleGutenbergEditorNotices() {
          fn.a.subscribe(async () => {
            const blocks = fn.a.select('core/block-editor').getBlocks();
        ...
        getPostId() {
          return fn.a.select('core/editor').getCurrentPostId();
        },
        ...
        createNotice() {
          const noticeText = __('This page uses the WooCommerce Cart Block. Before editing the page with Elementor and using the Elementor Cart widget, please check out this article.', 'elementor-pro'),
            ...
            linkUrl = 'https://go.elementor.com/dash-woocommerce-cart-block/';
          fn.a.dispatch('core/notices').createNotice('warning', noticeText, {
        ...
        removeNotice() {
          fn.a.dispatch('core/notices').removeNotice('elementor-woocommerce-editor-block-notice');
        },
        getCartNoticeDismissalState() {
          return fetch(`${elementorCommon.config.urls.rest}elementor-pro/v1/get-notice-dismissed/${this.getPostId()}`, {
            ...
            headers: {
              ...
              'X-Nonce': elementorWebCliConfig.nonce
            }
          }).then(response => {
